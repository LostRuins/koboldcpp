<p align="center">
  <a href="https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=koboldcpp">
    <img src="media/atlas-cloud-logo.png" alt="Atlas Cloud" width="200">
  </a>
</p>

> 🎁 **[Atlas Cloud](https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=koboldcpp)** is a cloud AI inference platform — access DeepSeek-V4, Qwen3, Wan2, Kling, Flux and 50+ models without needing a local GPU, through one OpenAI-compatible API endpoint. A great cloud complement to koboldcpp. [View all models](https://www.atlascloud.ai/models) · [Coding Plan](https://www.atlascloud.ai/console/coding-plan)
